...
var refreshReviewNoticeTable = function (data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        a.href = 'reviewdetail.html?' + "No=" + data[i].No;
...
var refreshPageList = function () {
    ...
    var a = document.createElement('a');
    var hrefStr = "review.html?page=" + String(((pageN - 1) <= 0) ? 1 : (pageN - 1));
    if (params.length > 1)
    ...
    for (var i = 0; i < frontPageN - 1; i++) {
        ...
        var hrefStr = "review.html?page=" + String(tmpPageNum);
        if (params.length > 1)
            hrefStr += "&option=" + params[1] + "&keyword=" + params[2];
        var a = document.createElement('a');
        a.href = hrefStr;
    ...
    var hrefStr = "review.html?page=" + String(pageN);
    if (params.length > 1)
        hrefStr += "&option=" + params[1] + "&keyword=" + params[2];
    var a = document.createElement('a');
    a.href = hrefStr;
    ...
    var a = document.createElement('a');
    var hrefStr = "review.html?page=" + String((pageN * SHOW_NUM > count) ? pageN : (pageN + 1));
    if (params.length > 1)
        hrefStr += "&option=" + params[1] + "&keyword=" + params[2];
    a.href = hrefStr;
    a.className = "list-group-item list-group-item-primary pageListItem"
...
var searchFunc = function () {
    ...
    var hrefStr = 'review.html?page=1';
    if (searchKeyword != '')
